...
def update_discount_DB(connection_params, discount_prediction_model, table_name = 'products'): 
    ...
    try:
        ...
        print(f"{table_name} table updated successfully with %s rows affcted.", (len(rows)))
...
if __name__ == "__main__":    
    discount_prediction_model = load_model(model_path = 'discount_prediction_model.pkl')
